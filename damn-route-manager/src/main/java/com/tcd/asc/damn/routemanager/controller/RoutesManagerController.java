...
public class RoutesManagerController {
    ...
    public RoutesResponse findRoutes(@RequestBody RouteRequest routeRequest) {
        List<RouteResponse> routes = routesManagerService.getRoutes(routeRequest);
        RoutesResponse routesResponse = new RoutesResponse();
        routesResponse.setStartLocation(routeRequest.getStartLocation());
        routesResponse.setEndLocation(routeRequest.getEndLocation());
